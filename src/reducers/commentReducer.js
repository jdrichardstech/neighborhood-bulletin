  ...
  switch (action.type) {
    case constants.COMMENT_UPDATED:
      ...
      list.forEach((comment, i) => {
        if (comment._id == action.comment._id) newList.push(action.comment);
        else newList.push(comment);
      });
    ...
    case constants.COMMENTS_RECEIVED:
      ...
      if (zoneComments == null) zoneComments = [];
      else zoneComments = Object.assign([], zoneComments);
    ...
    case constants.COMMENT_CREATED:
      ...
      else commentList = Object.assign([], commentList);
