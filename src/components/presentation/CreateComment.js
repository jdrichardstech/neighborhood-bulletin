...
class CreateComment extends Component {
  ...
  render() {
    let newImage =
      this.state.comment.commentImage == null && this.state.picDropped == false
        ? null
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div style={{ padding: '20px 30px 20px 30px' }}>
              <h3>Post:</h3>
              <input
                style={{ width: '75%', padding: '0 0 20px 0' }}
        ...
        <div className="row">
            ...
            <div style={{ padding: '35px 0 30px 30px' }}>
              ...
              >
                <a href="#dropzoneSpot">
                  ...
                  <i className="ml-1 no-mr zmdi zmdi-long-arrow-up" />
                </a>
              </DropZone>
            </div>
          </div>
          <div className="col-md-6" style={{ paddingRight: 30 }}>
            <div style={{ marginTop: 50 }}>
              <img style={{ height: 100 }} src={newImage} ref="imageUrl" />
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-md-12" style={{ padding: 30 }}>
            <a
              ...
              style={{ width: '30%', color: 'white', margin: '0 auto' }}
              onClick={this.submitComment.bind(this)}
              href="javascript:void(0)"
              className="btn btn-primary btn-raised btn-block animate-icon"
              data-dismiss="modal"
            >
              Submit Post&nbsp;&nbsp;
