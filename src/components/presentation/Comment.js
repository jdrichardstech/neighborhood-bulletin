...
class Comment extends Component {
  ...
  render() {
    let newImage =
      this.state.updated == null && this.state.picDropped == false
        ? null
    ...
    const showEditButton =
      ...
      this.state.showEdit == true ? (
        <div className="col-lg-4 text-right">
          ...
          >
            <i className="ml-1 no-mr zmdi zmdi-edit" />
            &nbsp;&nbsp;Edit
          </a>
        </div>
      ) : null;

    const commentEditingInfo =
          ...
          <div className="row">
            ...
            <div className="col-md-6" style={{ padding: 30 }}>
              <div style={{ marginTop: 50 }}>
                <img style={{ height: 100 }} src={newImage} ref="image" />
              </div>
            </div>
          </div>
          <div className="row">
              ...
              <div className="row">
                <div className="col-md-6" style={{ padding: 10 }}>
                  <a
                    ...
                    href="javascript:void(0)"
                    className="pull-right btn btn-primary btn-raised btn-block animate-icon"
                  >
                    Submit&nbsp;&nbsp;
                    <i className="ml-1 no-mr zmdi zmdi-long-arrow-right" />
                  </a>
                </div>
                <div className="col-md-6" style={{ padding: 10 }}>
                  <a
                    ...
                    href="javascript:void(0)"
                    className="pull-left btn btn-danger btn-raised btn-block "
                  >
                    <i className="ml-1 no-mr zmdi zmdi-close" />
                    &nbsp;&nbsp;Cancel
                  </a>
                </div>
          ...
          <div className="card-block">
            <div className="row">
              <div className="col-lg-6">
                <img
                  src={currentComment.commentImage}
                  alt=""
              ...
              <div className="col-lg-8">
                <Link to={'/profile/' + currentComment.username}>
                  <img
                    ...
                    src={author.image}
                    alt="..."
                    className="img-circle mr-1"
                  />
                </Link>
                by&nbsp;
                <a className="ms-tag ms-tag-primary" href="javascript:void(0)">
                  <Link
                    style={{ color: 'white' }}
                ...
                <span className="ml-1 hidden-xs">
                  <i className="zmdi zmdi-time mr-05 color-info" />
                  <span className="color-medium-dark">
