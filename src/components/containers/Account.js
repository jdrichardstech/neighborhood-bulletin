            ...
            <div className="ms-hero-page-override ms-hero-img-city ms-hero-bg-dark-light">
              <div className="container">
                <div className="text-center">
                  ...
                  <p className="lead lead-lg color-white text-center center-block mt-2 mw-800 text-uppercase fw-500 animated fadeInUp animation-delay-7">
                    Share and discover happenings and observances in your
                    neighborhood Please register or Login
                    <br />
                    <br />
                  </p>
                </div>
                  ...
                  <div className="card card-hero card-primary animated fadeInUp animation-delay-7">
                    <div className="card-block">
                      ...
                      <center>
                        ...
                        >
                          {' '}
                          If you do not want to register...feel free to login
                          with
                          <br />
                      ...
                      <form>
                        <fieldset>
                          ...
                          <div className="form-group label-floating">
                            <div className="input-group">
                              <span className="input-group-addon">
                                <i className="zmdi zmdi-puzzle-piece" />
                              </span>
                  ...
                  <div className="card animated fadeInUp animation-delay-7">
                    <div className="ms-hero-bg-info ms-hero-img-mountain">
                      <h3
                        ...
                        style={{ fontWeight: 300, fontSize: '2.3em' }}
                      >
                        <Link
                          style={{ color: 'white' }}
                    ...
                    <div className="card-block pt-4 text-center">
                      ...
                      <p>
                        <span style={{ color: '#03a9f4' }}>Gender: </span>
                        {this.props.user.gender}
                      </p>
                      <p>
                        <span style={{ color: '#03a9f4' }}>City: </span>
                        {this.props.user.city}
                      </p>
                      <p>
                        <span style={{ color: '#03a9f4' }}>Bio: </span>{' '}
                        {this.props.user.bio}
                      </p>
                      &nbsp;
                      <Link
