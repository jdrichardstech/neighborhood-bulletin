    ...
    return (
      <div style={styles.zone.zonedetails}>
        ...
        <div style={styles.zone.container}>
          ...
          <h3>
            Zip Code:{' '}
            <span style={styles.profile.entry}>
        ...
        <div style={styles.zone.container}>
          ...
          <input
            ...
            type="text"
            defaultValue={this.props.list[this.props.selected].name}
          />
          <br />
          ...
          <input
            ...
            className="form-control"
            type="text"
            defaultValue={this.props.list[this.props.selected].zipCodes}
          />
          <br />
          <button onClick={this.submitZone.bind(this)} className="btn btn-info">
            Update Zone
          </button>
        </div>
      </div>
